    ...
    <div className="cart-container">
      ...
      <div className="answers">
        ...
        <h4>আমরা প্রথমে Components নামে একটা জিনিস লিখি যেটা কে সিম্পল ভাবে কোড বলা হয় . 
          সেই কোড গুলা কে রিয়েক্ট UI  তে দেখানোর জন্য সেটা কে HTML এ Convert করে . তারপর সেটা কে UI তে দেখায়. আর সেই UI তে দেখানোর আগে সেটা কে HTML এ Convert করতে React Dom কাজ করে ।
        ...
        <h4>Props : এটা একটা Component থেকে আরেকটা Component এ ডাটা পাঠায় ,এবং টা অপরিবর্তনযোগ্য,সেটা শুধু পড়ার জন্য ,সেটা তে ইডিত করা বা লেখার জন্য না ।সেগুলো কে সংশোধন করা যায় না ।</h4>


        <h4>State : এটা হলো পরিবর্তনশীল ,এটা একটা Application থেকে আরেকটা Application এ ডাটা পাঠায়. প্রত্যেক টা Component এর State থাকতে পারে । এবং তা চাইলে মন মত পরিবর্তন ও করা যাবে কিন্তু Props এ এটা যাবে না । </h4>
